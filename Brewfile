...
brew "composer"
brew "wp-cli"
brew "cloudflared"                     # devstack share: public URL for a local site (named or quick tunnel)
...
# Extensions WordPress plugins commonly need, prebuilt per PHP version (object caches + image processing).
...
brew "shivammathur/extensions/redis@8.6"
...
brew "shivammathur/extensions/imagick@8.6"
brew "shivammathur/extensions/memcached@7.4"
brew "shivammathur/extensions/memcached@8.0"
brew "shivammathur/extensions/memcached@8.1"
brew "shivammathur/extensions/memcached@8.2"
brew "shivammathur/extensions/memcached@8.3"
brew "shivammathur/extensions/memcached@8.4"
brew "shivammathur/extensions/memcached@8.5"
brew "shivammathur/extensions/memcached@8.6"
